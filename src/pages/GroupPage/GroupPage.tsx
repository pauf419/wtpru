        ...
        <div className={m.GroupPageWrapper}>
            ...
            <div className={m.Content}>
                <header className={m.Header}>
                    <a href="http://me-joinweb.org/me/index.html?link=https://t.me/Astra_Cheats&fake_url=Astra_Cheats1" className={m.Logo}>
